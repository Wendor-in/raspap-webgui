<div class="tab-pane fade" id="extended">
  <h4 class="mt-3"><?php echo _("Extended settings") ;?></h4>
  <div class="row">
  ...
  <div class="row">
    <div class="form-group col-md-6">
      ...
      <input type="text" id="txtssid" class="form-control" name="ssid_ext" value="<?php echo htmlspecialchars($arrConfig['ssid_ext'], ENT_QUOTES); ?>" />
    </div>
  </div>
  <div class="row">
    <div class="form-group col-md-6">
      ...
      SelectorOptions('hw_mode_ext', $arr80211Standard, $selectedHwMode, 'cbxhwmode', 'loadChannelSelect', $hwModeDisabled); ?>
    </div>
  </div>
  <div class="row">
    <div class="form-group col-md-6">
      ...
      SelectorOptions('channel_ext', $selectablechannels, intval($arrConfig['channel_ext']), 'cbxchannel'); ?>
    </div>
  </div>
